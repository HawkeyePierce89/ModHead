  ...
  return (
    <div
      className={`bg-white p-5 rounded-lg shadow border-l-4 ${
        !rule.enabled ? 'opacity-60 border-l-[#95a5a6]' : 'border-[#3498db]'
      }`}
    >
      <div className="flex items-center justify-between mb-[15px]">
        <div className="flex items-center gap-[15px]">
          <label className="relative w-[50px] h-6">
            ...
            />
            <span
              className="absolute cursor-pointer inset-0 bg-[#ccc] transition-all duration-[0.4s] rounded-[24px]
                peer-checked:bg-[#3498db] before:absolute before:content-[''] before:h-[18px] before:w-[18px]
                before:left-[3px] before:bottom-[3px] before:bg-white before:transition-all before:duration-[0.4s]
                before:rounded-full peer-checked:before:translate-x-[26px]"
            />
          </label>
